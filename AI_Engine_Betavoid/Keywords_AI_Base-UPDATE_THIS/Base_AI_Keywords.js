...
const folderPath = path.join(__dirname, 'Public'); // Specify the folder name here
const filePath = path.join(folderPath, 'Variable_Extractor_Model.txt');                     // Specify the file path here so it can use
//readTextFile(filePath);                                                           //uncomment this when making bundle
